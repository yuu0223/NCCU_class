...
CREATE TABLE `DEPARTMENT` (
  ...
  CONSTRAINT `FK_MGRSSN` FOREIGN KEY (`MGRSSN`) REFERENCES `EMPLOYEE` (`SSN`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE `DEPENDENT` (
  ...
  CONSTRAINT `FK_DEP_ESSN` FOREIGN KEY (`ESSN`) REFERENCES `EMPLOYEE` (`SSN`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `DEPT_LOCATIONS` (
  ...
  CONSTRAINT `FK_DNUMBER` FOREIGN KEY (`DNUMBER`) REFERENCES `DEPARTMENT` (`DNUMBER`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `EMPLOYEE` (
  ...
  CONSTRAINT `FK_SUPERSSN` FOREIGN KEY (`SUPERSSN`) REFERENCES `EMPLOYEE` (`SSN`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PROJECT` (
  ...
  CONSTRAINT `FK_DNUM` FOREIGN KEY (`DNUM`) REFERENCES `DEPARTMENT` (`DNUMBER`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `WORKS_ON` (
  ...
  KEY `FK_PNO_idx` (`PNO`),
  CONSTRAINT `FK_ESSN` FOREIGN KEY (`ESSN`) REFERENCES `EMPLOYEE` (`SSN`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_PNO` FOREIGN KEY (`PNO`) REFERENCES `PROJECT` (`PNUMBER`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-18 16:57:52
